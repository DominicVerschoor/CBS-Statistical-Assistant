...
from utils import initialize_db_connection, build_few_shots_prompt, generate_sql_query, run_query, get_vertexai_llm, chain_query
...
def main():
    ...
    if st.button("Gemini-Pro"):
        with st.spinner("Thinking..."):
            ...
            # Final answer
            answer = chain_query(llm = llm, sql_response=query_results, user_question=user_question)
